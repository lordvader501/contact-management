    ...
    <div className='h-screen w-full flex justify-center bg-black bg-opacity-95'>
      <div className='p-6 w-full flex flex-col justify-start items-center'>
        ...
        { 
          query.data?.length === 0 ? 
            (
              <div className='text-yellow-700 border-[5px] border-dotted border-yellow-700 rounded-2xl flex flex-row text-center p-5 m-6 w-1/2 md:w-3/4 sm:w-full max-[600px]:w-full'>
